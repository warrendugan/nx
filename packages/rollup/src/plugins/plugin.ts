...
async function buildRollupTarget(
  ...
  try {
    ...
    const m = require(join(
      context.workspaceRoot,
      // This is the same path for Rollup 2, 3, 4.
      // See:
      // - https://www.unpkg.com/browse/rollup@2.79.1/package.json
      // - https://www.unpkg.com/browse/rollup@3.29.4/package.json
      // - https://www.unpkg.com/browse/rollup@4.18.0/package.json
